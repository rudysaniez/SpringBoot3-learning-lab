...
import com.springboot.learning.authorization.jose.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient writerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("attribute-client")
                .clientSecret("{noop}attribute_secret")
                ...
                .redirectUri("https://localhost:7070/openapi/webjars/swagger-ui/oauth2-redirect.html")
                .redirectUri("http://localhost:9080/openapi/webjars/swagger-ui/oauth2-redirect.html")
                .scope(OidcScopes.OPENID)
                .scope("attribute:read")
                .scope("attribute:write")
